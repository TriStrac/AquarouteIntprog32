...
class OwnerRegistrationPage4 : AppCompatActivity() {
    ...
    private fun createOwnerAccount(email: String?, password: String?, stationName: String?, region: String?, street: String?, unit: String?, phone: String?, name: String?, type: String?) {
        ...
        if (email != null) {
            ...
            reference.child(encodedEmail).setValue(ownerUser)
        }
    }
